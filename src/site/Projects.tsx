    ...
    return <div> 
            ...
            <div className="col">
                    <div className="card text-bg-dark mb-3">
                        <img src="src/images/MyWebsite.jpg" className="card-img-top" alt="..."></img>
                        <div className="card-body">
                            ...
                            <a href="#" className="btn btn-light">Go to Git</a>
                        </div>
                    </div>
                    <div className="col">
                    <div className="card text-bg-dark mb-3">
                        <img src="src/images/LittleAdventure2.png" className="card-img-top" alt="..."></img>
                        <div className="card-body">
                ...
                <div className="col">
                    <div className="card text-bg-dark mb-3">
                    <img src="src/images/SpeisenOase-Logo.jpg" className="card-img-top" alt="..."></img>
                    <div className="card-body">
                        ...
                        <a href="https://gitlab.mi.hdm-stuttgart.de/js485/speisen-oase.git" className="btn btn-light">Go to Git</a>
                    </div>
                    </div>
                </div>
                <div className="col">
                    <div className="card text-bg-dark mb-3">
                        <img src="src/images/Rayleigh.jpeg" className="card-img-top" alt="..."></img>
                        <div className="card-body">
