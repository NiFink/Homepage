    ...
    return <div> 
            ...
            <div className="col">
                    <div className="card text-bg-dark mb-3">
                        <img src="../src/images/AboutMe.jpg" className="card-img-top" alt="..."></img>
                    ...
                    <div className="col">
                    <div className="card text-bg-dark mb-3">
                        <img src="homepage/src/images/AboutMe.jpg" className="card-img-top" alt="..."></img>
                        <div className="card-body">
                ...
                <div className="col">
                    <div className="card text-bg-dark mb-3">
                    <img src="./images/AboutMe.jpg" className="card-img-top" alt="..."></img>
                    <div className="card-body">
